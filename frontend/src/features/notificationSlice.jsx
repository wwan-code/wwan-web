...
export const markAsRead = createAsyncThunk(
    ...
    async (notificationId, { dispatch, rejectWithValue }) => {
        try {
            const response = await api.put(`${API_URL}/${notificationId}/read`, {}, { headers: authHeader() });
            if (response.data?.success) {
...
export const markAllAsRead = createAsyncThunk(
    ...
    async (_, { dispatch, rejectWithValue }) => {
        try {
            const response = await api.put(`${API_URL}/read-all`, {}, { headers: authHeader() });
            if (response.data?.success) {
...
export const deleteNotification = createAsyncThunk(
    ...
    async (notificationId, { dispatch, rejectWithValue }) => {
        try {
            const response = await api.delete(`${API_URL}/${notificationId}`, { headers: authHeader() });
            if (response.data?.success) {
