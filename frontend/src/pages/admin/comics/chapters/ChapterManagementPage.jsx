...
const BatchUploadChapters = ({ comicId, comicSlug }) => {
    ...
    const handleUpload = async () => {
        ...
        try {
            const response = await api.post('/admin/comics/batch-upload-chapters', formData, {
                headers: authHeader(),
...
const ChapterManagementPage = () => {
    ...
    const fetchComicAndChapters = useCallback(async () => {
        ...
        try {
            const comicRes = await api.get(`/admin/comics/${comicId}`, { headers: authHeader() });
            ...
            const chaptersRes = await api.get(`/comics/${comicId}/chapters`, {
                headers: authHeader(),
    ...
    const handleSubmitChapterForm = async (formData, chapterIdToUpdate) => {
        ...
        try {
            const url = chapterIdToUpdate ? `/admin/chapters/${chapterIdToUpdate}/info` : '/admin/chapters';
    ...
    const handleDeleteChapter = async (chapterId) => {
        ...
        try {
            await api.delete(`/admin/chapters/${chapterId}`, { headers: authHeader() });
