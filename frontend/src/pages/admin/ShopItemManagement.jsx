...
import { useShopItemManagementLogic } from '@hooks/useShopItemManagementLogic';
    ...
    return (
        <div className="container-fluid flex-grow-1 container-p-y">
            <h4 className="py-3 mb-4">
                <span className="text-muted fw-light">Gamification /</span> Quản lý Cửa hàng Vật phẩm
            </h4>
            ...
            <div className="card mt-4">
                ...
                <div className="card-body">
                    ...
                    <ShopItemTable
                        ...
                        isSubmitting={isSubmitting}
                    />
                    {/* Pagination (Giữ nguyên từ GenreManagement) */}
                    {(totalPages > 0) && (
