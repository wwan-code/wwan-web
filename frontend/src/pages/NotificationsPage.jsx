        ...
        <div className="container notifications-page-container mb-5">
            <div className="notifications-page-header">
                ...
                {notifications.length > 0 && unreadCount > 0 && (
                    <button
                        className="btn-custom btn--outline-secondary btn--sm"
                        onClick={handleGlobalMarkAllRead}
                        disabled={loadingNotifications}
                    >
                        <i className="fas fa-check-double icon-before"></i> Đánh dấu đọc tất cả
                    </button>
                )}
            </div>
            ...
            {loadingNotifications !== 'pending' && !notificationError && notifications.length === 0 && (
                <div className="alert-message alert-info text-center empty-notifications">
                    ...
                    <Link to="/" className="btn-custom btn--outline-primary btn--sm mt-2">
                        <i className="fas fa-home icon-before"></i> Về Trang Chủ
                    </Link>
                </div>
            )}
