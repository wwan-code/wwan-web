                ...
                <div className='movie-area__slide-cover'>
                    <div className='movie-area__slide-cover-wrap'>
                        <picture className="movie-area__slide-image movie-area__slide-cover-image">
                            <source srcSet={movieData.image ? `${process.env.REACT_APP_API_URL}/${movieData.image}` : ''} type="image/webp" />
                            <img src={movieData.image ? `${process.env.REACT_APP_API_URL}/${movieData.image}` : '/placeholder.jpg'} alt={movieData.title} loading='lazy' />
                        </picture>
                    </div>
                </div>
            </div>
...
function MovieArea({ data }) {
    ...
    }, [data.featuredMovies, updateThumbData]);
                                        ...
                                        <div className="movie-area__slide">
                                            <div className="movie-area__slide-content movie-area__slide-content--left">
                                                <div className='movie-area__slide-cover'>
                                                    <div className='movie-area__slide-cover-wrap'>
                                                        <picture className="movie-area__slide-image movie-area__slide-cover-image">
                                                            <source srcSet={item.image ? `${process.env.REACT_APP_API_URL}/${item.image}` : ''} type="image/webp" />
                                                            <img src={item.image ? `${process.env.REACT_APP_API_URL}/${item.image}` : '/placeholder.jpg'} alt={item.title} loading='lazy' />
                                                        </picture>
                                                    </div>
                                                </div>
                                            </div>
