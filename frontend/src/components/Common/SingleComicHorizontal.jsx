...
const SingleComicHorizontal = ({ comic, onRemove, showRemoveButton = false }) => {
    ...
    const coverImageUrl = comic.coverImage ? (comic.coverImage.startsWith('http') ? comic.coverImage : `${process.env.REACT_APP_API_URL}/uploads/${comic.coverImage}`) : '/placeholder-comic.png';
