                    ...
                    <ListGroup variant="flush">
                        {watchlist.movies.map(movie => (
                            <ListGroup.Item key={movie.id} className="d-flex justify-content-between align-items-center px-0 py-2">
                                <div className="d-flex align-items-center">
                                    <img src={movie.poster ? `${process.env.REACT_APP_API_URL}/${movie.poster}` : '/placeholder.jpg'} alt={movie.title} width="40" height="60" className="me-2 rounded object-fit-cover" />
                                    <div>
