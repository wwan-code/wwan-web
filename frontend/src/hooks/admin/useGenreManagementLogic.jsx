...
export const useGenreManagementLogic = () => {
    ...
    const fetchGenres = useCallback(async () => {
        ...
        try {
            const response = await api.get("/genres", { headers: authHeader() });
    ...
    const handleSave = async (genreData, editingId) => {
        ...
        try {
            ...
            await api[method](url, genreData, { headers: authHeader() });
    ...
    const handleDelete = async (genreId) => {
        ...
        setIsSubmitting(true);
        try {
            await api.delete(`/genres/${genreId}`, { headers: authHeader() });
