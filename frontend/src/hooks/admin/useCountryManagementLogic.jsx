...
export const useCountryManagementLogic = () => {
    ...
    const fetchCountries = useCallback(async () => {
        ...
        try {
            const response = await api.get("/countries", { headers: authHeader() });
    ...
    const handleSave = async (countryData, editingId) => {
        ...
        try {
            ...
            const response = await api[method](url, countryData, { headers: authHeader() });
    ...
    const handleDelete = async (countryId) => {
        ...
        setIsSubmitting(true);
        try {
            await api.delete(`/countries/${countryId}`, { headers: authHeader() });
