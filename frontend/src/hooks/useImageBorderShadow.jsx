...
const useImageBorderShadow = (imageUrl) => {
    ...
    useEffect(() => {
        ...
        if (
            ...
            finalImageUrl = `${process.env.REACT_APP_URL}/uploads/${imageUrl.replace(/^\/+/, '')}`;
        }
        img.src = finalImageUrl.startsWith('http') ? finalImageUrl : `${process.env.REACT_APP_URL}/${finalImageUrl}`;
